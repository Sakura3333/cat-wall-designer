...
> **2026-07-16 状态说明：** 本文是早期开发规格，仍可用于理解原始架构意图；但组件 drop、raycast 命中、贴墙/落地约束、GLB 资产、禁用区域、距离测量、施工图和 BOM 已经在后续迭代中落地。继续开发前请先读 `docs/cat-wall-editor-handoff-2026-07-16.md`。
